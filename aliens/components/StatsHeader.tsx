...
const StatsHeader: React.FC<StatsHeaderProps> = ({ player, animateBalance, theme, onOpenAdmin }) => {
          ...
          <div className="flex items-center gap-3 flex-1">
            ...
            <div className="flex flex-col justify-center">
               <p className="font-bold text-white text-base leading-tight flex items-center gap-2">
                 {player.username}
                 {/* Admin Trigger: Hidden unless clicked, or visible for demo */}
                 <button onClick={onOpenAdmin} className="opacity-30 hover:opacity-100 transition-opacity">
