            ...
            <div className="absolute inset-0 p-6 flex flex-col justify-between z-10">
                <div className="flex justify-between items-start">
                    ...
                    <div className="flex flex-col gap-1 items-end">
                         <div className="flex gap-1">
                             <div className="w-1 h-2 bg-white/20 rounded-sm"></div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/10">
                    ...
                    <div className="text-right">
                         <span className="text-[9px] text-white/40 font-bold uppercase">Exp</span>
                         <span className="text-xs font-mono text-white">12/99</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
            <div className="relative group">
                ...
                <div className="relative bg-white dark:bg-slate-900 rounded-2xl p-1 flex items-center border border-slate-200 dark:border-slate-800">
                    <div className="pl-4 pr-3 text-slate-400 text-xl border-r border-slate-200 dark:border-slate-800 mr-2">
                        {isIndiaMode ? '🆔' : '⛓️'}
                    </div>
                    <input 
                        value={address}
                        ...
                        disabled={onCooldown}
                        className="w-full bg-transparent border-none text-slate-900 dark:text-white font-mono text-sm py-4 focus:ring-0 placeholder:text-slate-400 dark:placeholder:text-slate-600 tracking-wide"
                    />
                    {address && (
