...
const TaskCard: React.FC<{
  ...
  const verifyTelegramMembership = async () => {
    ...
    try {
        // Call Supabase Edge Function to verify membership
        // NOTE: You must deploy the 'verify-channel' function and set BOT_TOKEN secret
        ...
        if (data && data.joined) {
             ...
             // Re-open link just in case user needs to join
             if (task.link) {
